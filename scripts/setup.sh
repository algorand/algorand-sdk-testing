...
if ! $go
then
    go get -u github.com/algorand/go-algorand-sdk/...@evan/indexersupport
...
curl -L https://algorand-releases.s3.amazonaws.com/channel/stable/install_stable_darwin-amd64_2.0.4.tar.gz -o ~/inst/installer.tar.gz
