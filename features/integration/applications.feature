...
Feature: Applications
   ...
   Scenario: Use every applications feature in one scenario, do it!
      ...
      And I sign and submit the transaction. If there is an error it is "".
      ...
      And I sign and submit the transaction. If there is an error it is "invalid ApplicationArgs index 0".
      ...
      And I sign and submit the transaction. If there is an error it is "stack len is 3 instead of 1".
      # OptIn - success
      ...
      And I sign and submit the transaction. If there is an error it is "transaction rejected by ApprovalProgram".
      ...
      And I sign and submit the transaction. If there is an error it is "only clearing out is supported".
