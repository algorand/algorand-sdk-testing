Feature: Applications
   ...
   Scenario Outline: <state-location> test - Use every applications feature!
      ...
      And I sign and submit the transaction, saving the txid. If there is an error it is "logic eval error: dynamic cost budget exceeded, executing intc_1: local program cost was 700.".
