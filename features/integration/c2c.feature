...
Feature: Contract to Contract Interaction
  ...
  Scenario Outline: Compiled teals are as expected - skip the hash check
    ...
    Examples:
      | teal                            | program                             | result |
      | "programs/one.teal"             | "programs/one.teal.tok"             | "skip" |
      | "programs/fake_random.teal"     | "programs/fake_random.teal.tok"     | "skip" |
      | "programs/abi_method_call.teal" | "programs/abi_method_call.teal.tok" | "skip" |
      | "programs/localwrite.teal"      | "programs/localwrite.teal.tok"      | "skip" |
      | "programs/zero.teal"            | "programs/zero.teal.tok"            | "skip" |
      | "programs/big_app_program.teal" | "programs/big_app_program.teal.tok" | "skip" |

# THE NEXT ONE IS GOOD!

# Scenario Outline: Method call create execution
#   When I compile a teal program "programs/fake_random.teal"
#   Then it is compiled with <status> and <result> and <hash>
