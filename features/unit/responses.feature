...
Feature: REST Client Responses
  ...
  Scenario Outline: <client>: <endpoint> - <jsonfile>
    ...
    Examples:
      ...
      | indexer_unlimited_aa_AccountResponse_0.json             | generated_responses | 200    | indexer | lookupAccountByID         |
      | indexer_unlimited_aa_AccountsResponse_0.json            | generated_responses | 200    | indexer | searchForAccounts         |
      | indexer_unlimited_aa_ApplicationResponse_0.json         | generated_responses | 200    | indexer | lookupApplicationByID     |
      | indexer_unlimited_aa_ApplicationsResponse_0.json        | generated_responses | 200    | indexer | searchForApplications     |
      | indexer_unlimited_aa_AssetBalancesResponse_0.json       | generated_responses | 200    | indexer | lookupAssetBalances       |
      | indexer_unlimited_aa_AssetResponse_0.json               | generated_responses | 200    | indexer | lookupAssetByID           |
      | indexer_unlimited_aa_AssetsResponse_0.json              | generated_responses | 200    | indexer | searchForAssets           |
      | indexer_unlimited_aa_TransactionsResponse_0.json        | generated_responses | 200    | indexer | lookupAccountTransactions |
      | indexer_unlimited_aa_TransactionsResponse_0.json        | generated_responses | 200    | indexer | lookupAssetTransactions   |
      | indexer_unlimited_aa_TransactionsResponse_0.json        | generated_responses | 200    | indexer | searchForTransactions     |
      | indexer_unlimited_aa_TransactionsResponse_1.json        | generated_responses | 200    | indexer | lookupAccountTransactions |
      | indexer_unlimited_aa_TransactionsResponse_1.json        | generated_responses | 200    | indexer | lookupAssetTransactions   |
      | indexer_unlimited_aa_TransactionsResponse_1.json        | generated_responses | 200    | indexer | searchForTransactions     |
      | indexer_unlimited_aa_TransactionsResponse_2.json        | generated_responses | 200    | indexer | lookupAccountTransactions |
      | indexer_unlimited_aa_TransactionsResponse_2.json        | generated_responses | 200    | indexer | lookupAssetTransactions   |
      | indexer_unlimited_aa_TransactionsResponse_2.json        | generated_responses | 200    | indexer | searchForTransactions     |
      | indexer_unlimited_aa_ErrorResponse_0.json               | generated_responses | 500    | indexer | any                       |
      | algod_unlimited_aa_NodeStatusResponse_0.json            | generated_responses | 200    | algod   | GetStatus                 |
      | algod_unlimited_aa_NodeStatusResponse_0.json            | generated_responses | 200    | algod   | WaitForBlock              |
      | algod_unlimited_aa_CompileResponse_0.json               | generated_responses | 200    | algod   | TealCompile               |
      | algod_unlimited_aa_PostTransactionsResponse_0.json      | generated_responses | 200    | algod   | RawTransaction            |
      | algod_unlimited_aa_SupplyResponse_0.json                | generated_responses | 200    | algod   | GetSupply                 |
      | algod_unlimited_aa_TransactionParametersResponse_0.json | generated_responses | 200    | algod   | TransactionParams         |
      | algod_unlimited_aa_ApplicationResponse_0.json           | generated_responses | 200    | algod   | GetApplicationByID        |
      | algod_unlimited_aa_AssetResponse_0.json                 | generated_responses | 200    | algod   | GetAssetByID              |
      | algod_unlimited_aa_ErrorResponse_0.json                 | generated_responses | 500    | algod   | any                       |

    @unit.responses.231
    Examples:
      | jsonfile                                          | response-folder         | status | client  | endpoint                  |
      | indexer_unlimited_aa_AccountResponse_0.json       | generated_responses_231 | 200    | indexer | lookupAccountByID         |
      | indexer_unlimited_aa_AccountsResponse_0.json      | generated_responses_231 | 200    | indexer | searchForAccounts         |
      | indexer_unlimited_aa_ApplicationResponse_0.json   | generated_responses_231 | 200    | indexer | lookupApplicationByID     |
      | indexer_unlimited_aa_ApplicationsResponse_0.json  | generated_responses_231 | 200    | indexer | searchForApplications     |
      | indexer_unlimited_aa_AssetBalancesResponse_0.json | generated_responses_231 | 200    | indexer | lookupAssetBalances       |
      | indexer_unlimited_aa_AssetResponse_0.json         | generated_responses_231 | 200    | indexer | lookupAssetByID           |
      | indexer_unlimited_aa_AssetsResponse_0.json        | generated_responses_231 | 200    | indexer | searchForAssets           |
      | indexer_unlimited_aa_TransactionsResponse_0.json  | generated_responses_231 | 200    | indexer | lookupAccountTransactions |
      | indexer_unlimited_aa_TransactionsResponse_0.json  | generated_responses_231 | 200    | indexer | lookupAssetTransactions   |
      | indexer_unlimited_aa_TransactionsResponse_0.json  | generated_responses_231 | 200    | indexer | searchForTransactions     |
      | indexer_unlimited_aa_TransactionsResponse_1.json  | generated_responses_231 | 200    | indexer | lookupAccountTransactions |
      | indexer_unlimited_aa_TransactionsResponse_1.json  | generated_responses_231 | 200    | indexer | lookupAssetTransactions   |
      | indexer_unlimited_aa_TransactionsResponse_1.json  | generated_responses_231 | 200    | indexer | searchForTransactions     |
      | indexer_unlimited_aa_TransactionsResponse_2.json  | generated_responses_231 | 200    | indexer | lookupAccountTransactions |
      | indexer_unlimited_aa_TransactionsResponse_2.json  | generated_responses_231 | 200    | indexer | lookupAssetTransactions   |
      | indexer_unlimited_aa_TransactionsResponse_2.json  | generated_responses_231 | 200    | indexer | searchForTransactions     |
    ...
    Examples:
      | jsonfile                                                | response-folder     | status | client | endpoint                        |
      | algod_unlimited_aa_PendingTransactionResponse_0.base64  | generated_responses | 200    | algod  | PendingTransactionInformation   |
      | algod_unlimited_aa_PendingTransactionResponse_1.base64  | generated_responses | 200    | algod  | PendingTransactionInformation   |
      | algod_unlimited_aa_PendingTransactionsResponse_0.base64 | generated_responses | 200    | algod  | GetPendingTransactions          |
      | algod_unlimited_aa_PendingTransactionsResponse_1.base64 | generated_responses | 200    | algod  | GetPendingTransactions          |
      | algod_unlimited_aa_PendingTransactionsResponse_0.base64 | generated_responses | 200    | algod  | GetPendingTransactionsByAddress |
      | algod_unlimited_aa_PendingTransactionsResponse_1.base64 | generated_responses | 200    | algod  | GetPendingTransactionsByAddress |
