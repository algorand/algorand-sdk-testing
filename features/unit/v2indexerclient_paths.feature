...
Feature: Indexer Client v2 Paths
  ...
  Scenario Outline: SearchForBlockHeaders path
    ...
    Examples:
      | path                                                                                                        | 
      minRound | maxRound | limit | nextToken        | beforeTime              | afterTime               | 
      proposers                                                                                                        | 
      expired                                                                                                        | 
      absent                                                                                                        |
      | /v2/block-headers?min-round=51                                                                   | 51      | 0        | 0     |                  |                         |                         |                                                                                                        |                                                                                                        |                                                                                                        |
      | /v2/block-headers?min-round=51&max-round=55                                                      | 51      | 55       | 0     |                  |                         |                         |                                                                                                        |                                                                                                        |                                                                                                        |
      | /v2/block-headers?min-round=51&limit=10                                                          | 51      | 0        | 10    |                  |                         |                         |                                                                                                        |                                                                                                        |                                                                                                        |
      | /v2/block-headers?min-round=51&next=token                                                        | 51      | 0        | 0     | token            |                         |                         |                                                                                                        |                                                                                                        |                                                                                                        |
      | /v2/block-headers?min-round=51&before-time=2019-10-12T07%3A20%3A50.52Z                           | 51      | 0        | 0     |                  | 2019-10-12T07:20:50.52Z |                         |                                                                                                        |                                                                                                        |                                                                                                        |
      | /v2/block-headers?min-round=51&after-time=2019-10-12T07%3A20%3A50.52Z                            | 51      | 0        | 0     |                  |                         | 2019-10-13T07:20:50.52Z
      |                                                                                                        |                                                                                                        |                                                                                                        |
      | /v2/block-headers?proposers=PNWOET7LLOWMBMLE4KOCELCX6X3D3Q4H2Q4QJASYIEOF7YIPPQBG3YQ5YI%2C7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q | 0        | 0        | 0     |                  |                         |                         
      | PNWOET7LLOWMBMLE4KOCELCX6X3D3Q4H2Q4QJASYIEOF7YIPPQBG3YQ5YI,7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q |                                                                                                        |                                                                                                        |
      | /v2/block-headers?expired=PNWOET7LLOWMBMLE4KOCELCX6X3D3Q4H2Q4QJASYIEOF7YIPPQBG3YQ5YI%2C7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q | 0        | 0        | 0     |                  |                         |                         
      |                                                                                                        
      | PNWOET7LLOWMBMLE4KOCELCX6X3D3Q4H2Q4QJASYIEOF7YIPPQBG3YQ5YI,7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q
      |                                                                                                        |
      | /v2/block-headers?absent=PNWOET7LLOWMBMLE4KOCELCX6X3D3Q4H2Q4QJASYIEOF7YIPPQBG3YQ5YI%2C7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q | 0        | 0        | 0     |                  |                         |                         
      |                                                                                                        |                                                                                                        
      | PNWOET7LLOWMBMLE4KOCELCX6X3D3Q4H2Q4QJASYIEOF7YIPPQBG3YQ5YI,7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q |
