...
Feature: Indexer Client v2 Paths
  ...
  Scenario Outline: SearchForTransactions path
    ...
    Examples:
      ...
      | /v2/transactions?currency-greater-than=0&group-id=A62qVigWtWo0laUzcE1iZY8+KXWzK1vSkgwN/eKgvjc=              |                                                            |              |        |         |                                                      | 0     | 0        | 0        | 0     |                         |                         | 0                   | 0                | 0     |             |                | A62qVigWtWo0laUzcE1iZY8+KXWzK1vSkgwN/eKgvjc= |
