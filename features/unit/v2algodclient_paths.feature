Feature: Algod REST API v2
  ...
  Scenario Outline: Pending Transaction Information
    ...
    Examples:
      |path | txid|
      |/v2/transactions/pending/5FJDJD5LMZC3EHUYYJNH5I23U4X6H2KXABNDGPIL557ZMJ33GZHQ?format=json | 5FJDJD5LMZC3EHUYYJNH5I23U4X6H2KXABNDGPIL557ZMJ33GZHQ|
  ...
  Scenario Outline: Pending Transaction Information
    ...
    Examples:
      |path | max|
      |/v2/transactions/pending?format=json | 0  |
      |/v2/transactions/pending?max=1&format=json | 1  |
  ...
  Scenario Outline: Pending Transactions By Address
    ...
    Examples:
      |path | account| max|
      |/v2/accounts/7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q/transactions/pending?format=json | 7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q   | 0  |
      |/v2/accounts/7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q/transactions/pending?max=1&format=json | 7ZUECA7HFLZTXENRV24SHLU4AVPUTMTTDUFUBNBD64C73F3UHRTHAIOF6Q   | 1  |
