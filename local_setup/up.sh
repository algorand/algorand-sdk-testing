...
echo "godog --no-colors --strict=true --format=pretty --tags=\"@unit.offline,@unit.algod,@unit.indexer,@unit.rekey,@unit.indexer.rekey,@unit.transactions,@unit.responses,@unit.applications,@unit.dryrun,@unit.tealsign\" ."
